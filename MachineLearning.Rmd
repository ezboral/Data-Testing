...
In this section we will use machine learning methods to build different types of models that will predict the probability of either a default or no default using the independent variables in our data set.  We will use build a logist regression model, a classification and regression tree (CART), and a random forest model.
