...
dcc$LA <- paste(dcc$LoanAmtBin, "-", dcc$AgeBin)
dcc$LG <- paste(dcc$LoanAmtBin, "-", dcc$Gender)
dcc$LE <- paste(dcc$LoanAmtBin, "-", dcc$Education)
dcc$LM <- paste(dcc$LoanAmtBin, "-", dcc$Marriage)
...
dcc$LAG <- paste(dcc$LoanAmtBin, "-", dcc$AgeBin, "-", dcc$Gender)
dcc$LAE <- paste(dcc$LoanAmtBin, "-", dcc$AgeBin, "-", dcc$Education)
dcc$LAM <- paste(dcc$LoanAmtBin, "-", dcc$AgeBin, "-", dcc$Marriage)

dcc$LAGE <- paste(dcc$LoanAmtBin, "-", dcc$AgeBin, "-", dcc$Gender, "-", dcc$Education)
dcc$LAGM <- paste(dcc$LoanAmtBin, "-", dcc$AgeBin, "-", dcc$Gender, "-", dcc$Marriage)
dcc$LAEM <- paste(dcc$LoanAmtBin, "-", dcc$AgeBin, "-", dcc$Education, "-", dcc$Marriage)

dcc$LAGEM <- paste(dcc$LoanAmtBin, "-", dcc$AgeBin, "-", dcc$Gender, "-", dcc$Education, "-", dcc$Marriage)
